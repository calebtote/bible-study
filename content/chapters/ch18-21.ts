  ...
  /* ================================================================== */
  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: "Difficult questions",
        body:
          "Joshua 21:45 says nothing failed of any good thing the LORD had spoken. Joshua 13:1 says very much land remains to be possessed. Joshua 23:12-14 puts both in one speech, warning about the nations that remain and then insisting that not one thing has failed. The book does not treat this as damage needing repair, and it is not silent about how the two fit: 13:1 announces the remaining land in the same breath that commands its allotment, 18:3 lays the delay at the tribes' feet rather than at God's, 23:5 keeps God's giving and Israel's possessing as two different verbs, and Exodus 23:29-30 had set out gradual dispossession as the design in advance.\n\nFour readings of the summaries are still on offer: that the promise concerned what God did rather than what Israel occupied; that the summaries use the conventional totalising language of ancient war reports; that Joshua deliberately holds gift and shortfall side by side; and that the passages come from different hands. Each accounts for part of it. What the book itself refuses is the comfortable version in either direction: it will not say the promise failed, and it will not say the task was finished.",
