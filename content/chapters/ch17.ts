...
export const MILESTONES: Milestone[] = [
  ...
  },
  {
    ...
    whatChanged:
      "The allotment does not shrink and no ground is lost. What appears is the gap this book keeps recording: the towns ringing the Jezreel valley are marked as Canaanite-held while standing inside Manasseh's assigned area, because assignment and possession are different claims.",
    geographyExplanation:
