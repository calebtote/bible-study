...
export const MILESTONES: Milestone[] = [
  ...
  },
  {
    ...
    whatChanged:
      "Nothing on the ground. A claim is entered: an oath made at Kadesh-barnea forty-five years earlier is put on the record in front of Joshua and the men of Judah.",
    geographyExplanation:
