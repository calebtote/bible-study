  ...
  /* ================================================================== */
  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: "Difficult questions",
        body:
          "The Kenizzite label is a genuine puzzle, though the wider canon says more than this chapter does. Genesis 36:11 lists [[entity:kenaz]] among the descendants of Esau, and Joshua twice attaches the label to [[entity:caleb]]. But Numbers 13:6 names Caleb a man of Judah without qualification, and 1 Chronicles 4:13-15 carries a Kenaz inside Judah's genealogies. So Scripture asserts his full standing in Judah while preserving the foreign-sounding name; what it never does is explain the relation between them. Proposals exist: a Kenizzite clan absorbed into Judah, two unrelated lines named Kenaz, a genealogy reckoned by incorporation. If the name does reach back to an absorbed outsider clan, the book has quietly placed a grafted-in line at the head of Judah's inheritance, in the same chapters that bring [[entity:rahab]] inside Israel.\n\nThe forty-five years invites arithmetic the book never performs. Deuteronomy 2:14 gives thirty-eight years from [[entity:kadesh-barnea]] to the crossing of the Zered, which would leave roughly seven years for everything in Joshua 1 to 12. That is a reasonable inference. It is also an inference, not a statement, and Joshua gives no campaign chronology of its own.\n\n[[entity:hebron]] is given to Caleb here, granted again at Joshua 15:13-14, and named a Levitical city of refuge at Joshua 21:11-12, where Caleb keeps its fields and villages. Whether those are three notices of one grant or a record of later adjustment, we do not know.",
        scriptureRefs: [
          "Joshua 14:6",
          "Joshua 14:10",
          "Joshua 14:13",
