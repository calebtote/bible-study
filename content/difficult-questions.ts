...
export const DIFFICULT_QUESTIONS: DifficultQuestion[] = [
  ...
  /* ================================================================== */
  {
    ...
    ethicalNote:
      "This text has a documented history of misuse. Joshua was preached over the dispossession of indigenous peoples in the Americas, with settlers cast as Israel and the people already living there as Canaanites to be driven out or destroyed. It was quoted in English campaigns in Ireland to dress massacre as divine judgement, and it supplied the vocabulary of Afrikaner nationalism in South Africa, a chosen people entering a promised land. The book itself undercuts every such reading: it insists that Israel holds the land on the same terms as the nations displaced from it, and that the same judgement falls on Israel for the same behaviour (Joshua 23:15-16; 24:20).",
  ...
  /* ================================================================== */
  {
    ...
    ethicalNote:
      "Hyperbole is no comfort, and this entry makes no argument that the violence was smaller than it looks. Cities were taken, kings were executed, and populations were displaced; the most that follows from the comparative evidence is that the totalising phrases were never casualty figures. Royal inscriptions boasted of annihilation in order to terrify, which is worth remembering about what this language was for. Understanding the convention is a reason to handle these sentences with more care.",
