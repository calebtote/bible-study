 ...
 * of it. Where a reading is specifically Reformed it is labelled as Reformed and
 * presented as one Christian option rather than as the plain sense of the text.
 *
...
export const DIFFICULT_QUESTIONS: DifficultQuestion[] = [
  ...
  /* ================================================================== */
  {
    ...
    ethicalNote:
      "This text has been used to justify colonial conquest, massacre and displacement. That is not a hypothetical risk; it is documented history. Joshua was preached over the dispossession of indigenous peoples in the Americas, with settlers cast as Israel and the people already living there as Canaanites to be driven out or destroyed. It was quoted in English campaigns in Ireland to dress massacre as divine judgement. It supplied the vocabulary of Afrikaner nationalism in South Africa, a chosen people entering a promised land. It is still enlisted on more than one side of modern territorial conflicts. Every one of those uses is a misuse.\n\nNothing in the book of Joshua authorises anyone's violence now. The narrative presents the campaigns as a bounded episode under a specific command to a specific people at a specific moment, and it insists that Israel holds the land on exactly the same terms as the nations displaced from it, so that the same judgement falls on Israel for the same behaviour (Joshua 23:15-16; 24:20). No modern state, church, movement or person stands where Joshua stands in this narrative. The land laws of the Old Testament resist being turned into a template for anyone's territorial claim, and the conquest reports resist being turned into a precedent for anyone's war.\n\nThat applies to every reading on this page, including the ones that judge the narrative historically reliable. Concluding that the events happened is not concluding that they may be repeated. A reader who finishes this page more willing to countenance violence against a neighbour, a people or a nation has misread both the book and this study.",
  ...
  /* ================================================================== */
  {
    ...
    ethicalNote:
      "Hyperbole is not a comfort, and this entry is not an argument that the violence was smaller than it looks. Cities were taken, kings were executed, and populations were displaced; the most that follows from the comparative evidence is that the totalising phrases were not casualty figures. A reader who leaves this page relieved has taken the wrong thing from it.\n\nIt is also worth being clear about what this language was for. Royal inscriptions boasted of annihilation in order to terrify, and quoting such language about a people today does the same work it did three thousand years ago. The formulas in Joshua 10 and 11 have been recycled in sermons, speeches and propaganda to describe modern enemies, and that use is a misuse regardless of how the original idiom functioned. Understanding the convention is a reason to handle these sentences with more care, not less.",
  ...
  /* ================================================================== */
  {
    ...
    interpretations: [
      ...
      {
        label: "Covenant solidarity (a Reformed reading)",
        proponents: "Marten H. Woudstra; O. Palmer Robertson",
        summary:
          "This reading, labelled Reformed and offered as one Christian option among several, takes representation as a structural feature of the covenant rather than as an anomaly in this chapter. Israel is addressed and treated as a single body under a single covenant, so one man's breach really is Israel's breach, which is what 7:1 and 7:11 say. The head of a household stands for that household in the same way, and the book expects the reader to reason in that direction: Joshua 22:20 uses Achan to warn that a single act reaches everyone. On this account the chapter is not a lapse into primitive collective punishment but an application of how the covenant works, the same logic that elsewhere means blessing comes to a household through its head.",
        strengths:
  ...
  /* ================================================================== */
  {
    ...
    interpretations: [
      {
        label: "The lie was a real fault, pardoned rather than approved (a Reformed reading)",
        proponents: "John Calvin",
        summary:
          "Labelled as Reformed and offered as one Christian option, this is the classic casuistical position, and it is more careful than its summary reputation. Calvin holds that God's promise to deliver the spies was fulfilled through Rahab, that her faith was genuine and commendable, and that the falsehood was nonetheless a fault which God's mercy covered. The principle he explicitly refuses is that a good end makes a falsehood lawful. On this reading the saints' actions are not to be approved in every part, and Scripture's praise of Rahab's faith is not a blanket endorsement of her method.",
        strengths:
  ...
  /* ================================================================== */
  {
    ...
    interpretations: [
      {
        label: "Real fulfilment, phased possession (a Reformed covenantal reading)",
        proponents:
          "Marten H. Woudstra; O. Palmer Robertson; Geerhardus Vos; David M. Howard Jr.",
        summary:
          "Labelled Reformed where it draws on that tradition, and offered as one Christian reading among several. God's promise was to give the land, and he gave it; the giving is complete and the taking is a task. 21:43-45 is a true statement about God's action, not about Israel's occupancy, and 23:5 keeps the two apart precisely: 'Yahweh your God will thrust them out from before you. You shall possess their land.' Promise and command sit together in covenant, so a gift fully given can still be entered progressively, and failure to enter it is Israel's to answer for rather than a shortfall in God. On this reading the book is not in tension with itself; it is describing a gift and a responsibility that were always distinguishable.",
        strengths:
