 ...
 *  2. `reformedPerspective` continues the theme in the study's own theological
 *     voice, unlabelled, and names at least one other Christian tradition that
 *     reads the same material differently. The comparison stays substantive:
 *     other traditions appear in their own terms, never as foils.
...
Two implications follow that are easy to miss. First, inheritance language resists being read as conquest reward; a portion is what a family is owed within a household, and no army earns one. Second, the land laws of this tradition, with their lots, family portions, Levitical dependence and refuge provisions, are organised around limiting accumulation and protecting households. Reading them as a warrant for acquisition inverts the arrangement they describe.`,
...
Other traditions handle the same material differently. Roman Catholic social teaching reads the lot, the family portion and the jubilee restrictions primarily as grounding obligations about property and the poor. Dispensationalist readings hold the territorial grant to be an outstanding literal entitlement for national Israel, one that the partial possession in Joshua leaves standing. All three can quote Joshua 24:13; they differ on what kind of promise is being quoted.`,
      citations: [
        {
          sourceId: "woudstra-joshua",
          supportedClaim:
...
Anabaptist traditions have historically refused to swear oaths at all, on the strength of Jesus' words in Matthew 5, and from that standpoint Joshua 9 reads less as a lesson in oath-keeping than as a case study in why sworn commitments entangle the people of God. Wesleyan and Methodist theology, while affirming covenant, places more weight on the reality and resistibility of human response, and so hears Joshua 24:19-24 as a genuinely open transaction. None of these readings can claim Joshua settles the question.`,
      citations: [
        {
...
Roman Catholic and Eastern Orthodox theology read handovers of this kind with much more institutional weight, as the transmission of an office with continuing authority, and both traditions locate Christian ministry within a succession that Joshua's own ending conspicuously lacks. Anglican theology, holding an episcopal order alongside a strong doctrine of Scripture, sits between the two. Every tradition has to reckon with the same awkward fact: the book that narrates one successful succession appoints nobody at its close.`,
      citations: [
        {
          sourceId: "calvin-joshua",
...
Eastern Orthodox theology takes the opposite emphasis and takes it seriously: holy places, holy objects and the transfiguration of matter are integral to how God deals with his people, and on that reading Joshua 5:15 is a datum about sanctified space itself. Anglican sacramental theology, and Roman Catholic theology of pilgrimage and shrine, stand nearer that instinct. The passage does not adjudicate between them, and readers should know which instinct they are bringing to it.`,
      citations: [
        {
          sourceId: "bavinck-dogmatics",
          supportedClaim:
...
The text presents the campaigns as a bounded episode under a specific command to a specific people at a specific moment, and it offers no mechanism by which anyone later inherits that warrant. The book's own ethical trajectory runs the other way: it ends by warning Israel that it is liable to the same judgment it has just administered.`,
...
Anabaptist traditions read the conquest through a consistently Christocentric hermeneutic in which Jesus' teaching and example govern how earlier texts about violence may be used. That tradition also tends to suspect that providential accounts of the conquest make God's justice too easy to invoke. Some Christian readers, further out, hold that the portrayal should be criticised outright. The disagreement is real, and it is old.`,
      citations: [
        {
          sourceId: "calvin-joshua",
...
Roman Catholic and Eastern Orthodox theology give remembrance a fuller sacramental and liturgical density, in which memory is enacted as much as explained, and holy places, relics and pilgrimage carry weight that Reformed theology deliberately withholds from them. Anglican practice retains commemorative sites and a liturgical calendar in a way that sits between the two. Since Joshua's monuments are physical objects at identified locations, the traditions that take sacred place seriously can claim they are reading the text's own instincts, and that claim has real force.`,
      citations: [
        {
          sourceId: "westminster-confession",
...
Other traditions handle the same texts differently. Dispensationalist theology locates an outstanding rest for national Israel in a future millennial kingdom, and reads Joshua's partial rest as evidence that the territorial promise still awaits literal fulfilment. Roman Catholic theology has tended to speak of the final rest in terms of the beatific vision, with the Lord's Day as its weekly anticipation, which overlaps that account while framing the Sabbath itself differently. Hebrews 4:9 is common ground; what the Sabbath rest consists of is not.`,
      citations: [
        {
          sourceId: "vos-biblical-theology",
          supportedClaim:
